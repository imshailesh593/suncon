...
@php
  $services = [
    [
      ...
      'imgAlt'  => 'Architectural technical drawings and blueprints',
    ],
    [
      'id'      => 'structural',
      'number'  => '02',
      ...
      'imgAlt'  => 'Structural steel building frame under construction',
    ],
    [
      'id'      => 'mep',
      'number'  => '03',
      ...
      'image'   => 'https://images.unsplash.com/photo-1504297050568-910d24c426d3?w=900&q=85&auto=format&fit=crop',
      'imgAlt'  => 'Industrial MEP building systems and piping',
    ],
    [
      'id'      => 'scan',
      'number'  => '04',
      ...
      'image'   => 'https://images.unsplash.com/photo-1590114538379-8d0df7a3b486?w=900&q=85&auto=format&fit=crop',
      'imgAlt'  => 'Survey and scanning equipment for precision measurement',
    ],
    [
      'id'      => 'cad',
      'number'  => '05',
      ...
      'imgAlt'  => 'Technical drafting and architectural design workspace',
    ],
    [
      'id'      => 'docs',
      'number'  => '06',
      ...
      'imgAlt'  => 'Construction site with detailed documentation and planning',
    ],
  ];
@endphp
...
<section id="{{ $svc['id'] }}" style="background:{{ $i%2===0?'#0A0A0A':'#111111' }};border-top:1px solid rgba(255,255,255,0.05);" data-dark>
    ...
    <div class="flex-1 min-w-0 flex flex-col justify-center px-6 lg:px-0">
      <div class="{{ $i%2===0 ? 'lg:pl-12 xl:pl-20 lg:pr-16' : 'lg:pr-12 xl:pr-20 lg:pl-16' }} py-20 max-w-2xl {{ $i%2===0 ? 'lg:ml-auto' : 'lg:mr-auto' }}">
        ...
        <div class="flex items-center gap-5 mb-8" data-reveal>
          <span class="font-display font-light" style="font-size:clamp(3rem,8vw,7rem);line-height:1;color:rgba(255,255,255,0.04);">{{ $svc['number'] }}</span>
          <div style="width:48px;height:1px;background:rgba(181,69,27,0.5);"></div>
        </div>

        <h2 class="font-display font-light text-display-md leading-tight mb-5" style="color:#F2EFE9;" data-reveal>{{ $svc['title'] }}</h2>
        <p class="text-base leading-relaxed mb-6" style="color:#6B6560;" data-reveal>{{ $svc['lead'] }}</p>
        <p class="text-sm leading-relaxed mb-10" style="color:#4E4A47;" data-reveal>{{ $svc['body'] }}</p>
        ...
        <div style="border-top:1px solid rgba(255,255,255,0.06);padding-top:28px;" data-reveal>
          ...
          <p class="text-[10px] leading-relaxed mb-8" style="color:#4E4A47;">{{ $svc['formats'] }}</p>
        </div>
