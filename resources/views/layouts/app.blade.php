...
<head>
  ...
  <title>@yield('title', 'Suncon Engineers | Architecture, Landscape & Interior Design')</title>
  <meta name="description" content="@yield('description', 'Suncon Engineers Pvt. Ltd. — ISO-certified multidisciplinary consultancy delivering architecture, landscape, interior design, BIM, PMC and infrastructure across India since 1999.')">
  <!-- Google Fonts -->
